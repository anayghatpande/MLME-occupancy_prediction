# -*- coding: utf-8 -*-
"""
Created on Fri Jul  9 20:39:47 2021
...
input_data1 = df_building_clean.get('Floor4')[['AP_Total']]
output_data1 = df_building_clean.get('Floor4')[['Groundtruth']]
test_data_input1 = df_building_clean.get('Floor1W')[['AP_Total']]
test_data_output1 = df_building_clean.get('Floor1W')[['Groundtruth']]

input_data2 = df_building_clean.get('Floor4')[['Inst_kW_Load_Plug','AP_Total']]
output_data2 = df_building_clean.get('Floor4')[['Groundtruth']]
...
input_data = df_building_clean.get('Floor4')[['Inst_kW_Load_Plug','AP_Total','PIR_ALL']]
output_data = df_building_clean.get('Floor4')[['Groundtruth']]
test_data_input = df_building_clean.get('Floor1W')[['Inst_kW_Load_Plug','AP_Total','PIR_ALL']]
test_data_output = df_building_clean.get('Floor1W')[['Groundtruth']]

input_data4 = df_building_clean.get('Floor4')[['Inst_kW_Load_Plug','AP_Total','CO2_ALL','PIR_ALL']]
output_data4 = df_building_clean.get('Floor4')[['Groundtruth']]
test_data_input4 = df_building_clean.get('Floor1W')[['Inst_kW_Load_Plug','AP_Total','CO2_ALL','PIR_ALL']]
test_data_output4 = df_building_clean.get('Floor1W')[['Groundtruth']]
...
plt.title('Model 4th-Floor [R_2:%s] ' %w_1, fontsize=15, color= 'black', y= 1.1)
...
plt.figure(figsize=(12,5))
plt.title('Model 4th-Floor vs. Data 1st-FloorW, [R_2:%s] ' %w_2, fontsize=15, color= 'black', y= 1.1)
