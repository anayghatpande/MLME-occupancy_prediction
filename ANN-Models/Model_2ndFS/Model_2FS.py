# -*- coding: utf-8 -*-
"""
Created on Mon Jun  7 23:00:29 2021
...
input_data1 = df_building_clean.get('Floor2S')[['AP_Total']]
output_data1 = df_building_clean.get('Floor2S')[['Groundtruth']]
test_data_input1 = df_building_clean.get('Floor1W')[['AP_Total']]
test_data_output1 = df_building_clean.get('Floor1W')[['Groundtruth']]

input_data2 = df_building_clean.get('Floor2S')[['Inst_kW_Load_Plug','AP_Total']]
output_data2 = df_building_clean.get('Floor2S')[['Groundtruth']]
...
input_data3 = df_building_clean.get('Floor2S')[['Inst_kW_Load_Plug','AP_Total','PIR_ALL']]
output_data3 = df_building_clean.get('Floor2S')[['Groundtruth']]
...
input_data = df_building_clean.get('Floor2S')[['Inst_kW_Load_Plug','AP_Total','CO2_ALL','PIR_ALL']]
output_data = df_building_clean.get('Floor2S')[['Groundtruth']]
...
gt_model = get_keras_model(1,70,'relu',0.01,'relu',0.2)
...
plt.title('Model 2nd-FloorS vs. Data 2nd-FloorS [R_2:%s] ' %w_1, fontsize=15, color= 'black', y= 1.1)
...
plt.figure(figsize=(12,5))
plt.title('Model 2nd-FloorS vs. Data 2nd-FloorW, [R_2:%s] ' %w_2, fontsize=15, color= 'black', y= 1.1)
