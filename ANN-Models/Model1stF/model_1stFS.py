...
#summing up CO2 and PIR using lists of heads
...
#get Input and test data, to change amount of features, change variable name ti input_data and output-data
...
input_data = df_building_clean.get('Floor1S')[['Inst_kW_Load_Plug','AP_Total','CO2_ALL','PIR_ALL']]
...
plt.title('Model 1st-Floor [R_2:%s] ' %w_1, fontsize=15, color= 'black', y= 1.1)
