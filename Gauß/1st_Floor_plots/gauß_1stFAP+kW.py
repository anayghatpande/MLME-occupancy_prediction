...
X = df_building_clean.get('Floor1S')[['AP_Total','Inst_kW_Load_Plug']].values
X = (np.atleast_2d(X))
...
plt.title('Model_gauss 1st-FloorS vs. Data 1st-FloorS (AP+kW), [R_2:%s] ' %w_2, fontsize=15, color= 'black', y= 1.1)
...
plt.figure(figsize=(12,5))
plt.title('Model_gauss 1st-FloorS vs. Data 1st-FloorW (AP+kW), [R_2:%s] ' %w_2, fontsize=15, color= 'black', y= 1.1)
