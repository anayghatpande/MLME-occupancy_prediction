...
X = df_building_clean.get('Floor3')[['AP_Total','Inst_kW_Load_Plug','PIR_ALL']].values
X = (np.atleast_2d(X))
...
plt.title('Model_gauss 3rd-FloorS vs. Data 3rd-FloorS (AP+kW+PIR), [R_2:%s] ' %w_2, fontsize=15, color= 'black', y= 1.1)
...
plt.figure(figsize=(12,5))
plt.title('Model_gauss 3rd-FloorS vs. Data 1st-FloorW (AP+kW+PIR), [R_2:%s] ' %w_2, fontsize=15, color= 'black', y= 1.1)
