# -*- coding: utf-8 -*-
"""
Created on Sat Jul 10 15:54:34 2021
...
X11 = df_building_clean.get('Floor3')[['Inst_kW_Load_Plug','AP_Total','PIR_ALL','CO2_ALL']].values
X12 = df_building_clean.get('Floor3')[['Inst_kW_Load_Plug','AP_Total','PIR_ALL']].values
X13 = df_building_clean.get('Floor3')[['Inst_kW_Load_Plug','AP_Total']].values
...
plt.title('Model_gauss 3rd-Floor vs. Data 3rd-Floor (AP+kW+PIR+C), [R_2:%s] ' %w_2, fontsize=15, color= 'black', y= 1.1)
...
plt.figure(figsize=(12,5))
plt.title('Model_gauss 3rd-FloorS vs. Data 1st-FloorW (AP+kW+PIR+C), [R_2:%s] ' %w_2, fontsize=15, color= 'black', y= 1.1)
