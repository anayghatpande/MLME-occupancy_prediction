# -*- coding: utf-8 -*-
"""
Created on Thu Jul  8 12:57:07 2021
...
test_data_input = df_building_clean.get('Floor1S')[['Inst_kW_Load_Elec','AP_Total']]
test_data_output = df_building_clean.get('Floor1S')[['Groundtruth']]
...
plt.title('Model 4th-FloorS vs. Data 4th-FloorS [R_2:%s] ' %w_1, fontsize=15, color= 'black', y= 1.1)
...
plt.figure(figsize=(12,5))
plt.title('Model 4th-FloorS vs. Data 1st-FloorS, [R_2:%s] ' %w_2, fontsize=15, color= 'black', y= 1.1)
